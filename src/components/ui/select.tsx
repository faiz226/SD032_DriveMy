...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "transition-base [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <CaretDown className="h-4 w-4 opacity-50" weight="regular" aria-hidden />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <CaretUp className="h-4 w-4" weight="regular" aria-hidden />
  </SelectPrimitive.ScrollUpButton>
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <CaretDown className="h-4 w-4" weight="regular" aria-hidden />
  </SelectPrimitive.ScrollDownButton>
));
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "min-h-[40px] py-1.5 pl-8 pr-2 text-sm outline-none",

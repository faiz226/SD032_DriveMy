...
export class ZCurveScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    // Z-curve lane boundaries
    this.obstacles.add(this.add.rectangle(width * 0.33, height * 0.25, 8, height * 0.5, 0xef4444));
    this.obstacles.add(this.add.rectangle(width * 0.66, height * 0.75, 8, height * 0.5, 0xef4444));
    this.obstacles.add(this.add.rectangle(width * 0.33 + 60, height * 0.25, 8, height * 0.5, 0xef4444));
    this.obstacles.add(this.add.rectangle(width * 0.66 + 60, height * 0.75, 8, height * 0.5, 0xef4444));

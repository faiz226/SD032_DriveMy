...
export class SCurveScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    const cg = this.add.rectangle(60, height / 2, 40, 24, 0x3b82f6);
    ...
    // S-curve lane boundaries (simplified as straight segments)
    this.obstacles.add(this.add.rectangle(width * 0.3, height * 0.3, 8, height * 0.4, 0xef4444));
    this.obstacles.add(this.add.rectangle(width * 0.7, height * 0.7, 8, height * 0.4, 0xef4444));
    this.obstacles.add(this.add.rectangle(width * 0.3 + 60, height * 0.3, 8, height * 0.4, 0xef4444));
    this.obstacles.add(this.add.rectangle(width * 0.7 + 60, height * 0.7, 8, height * 0.4, 0xef4444));
    this.finishZone = this.add.zone(width - 60, height / 2, 40, 60);
